...
NUM_GAMES = 50
NUM_REVIEWS = 200
NUM_GENRES = 16  # As per your schema
NUM_CHATS = 20
NUM_MESSAGES = 200
NUM_FRIENDSHIPS = 150
...
with open("generated_data.sql", "w") as f:
    ...
    for i in range(NUM_ACCOUNTS):
        ...
        f.write(f"INSERT IGNORE INTO account (email, username, password_hash, profile_pic_url, account_banned, account_created, last_login) VALUES ('{email}', '{username}', '{password_hash}', {profile_pic_url if profile_pic_url != 'NULL' else 'NULL'}, 0, NOW(), NOW());\n")
